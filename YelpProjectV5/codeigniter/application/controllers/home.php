...
Class Home extends CI_Controller {
	...
	/*	$this->connection = new MongoClient('localhost:27017');
		...
		*/
		...
		$data['members'][12] = $this->get->getCheckinInfo(4,5);
		$data['members'][13] = $this->get->getCheckinInfo1(0,2);
		$data['members'][14] = $this->get->getCheckinInfo1(2,3);
		$data['members'][15] = $this->get->getCheckinInfo1(3,4);
		$data['reviews'] = $this->get->top100Reviews();
